  ...
  return (
    <div className='bg-black/50'>
        ...
        <form onSubmit={(e)=>{e.preventDefault();}} className=' rounded-2xl  flex flex-col px-6 py-9 gap-4 w-2/7 bg-black/75 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white'>
            ...
            <input ref={emailRef} type='' placeholder='Email' className=' w-full px-3 py-2 rounded bg-neutral-800'></input>
            <input ref={passRef} type='' placeholder='Password' className='px-3 py-2 rounded bg-neutral-800'></input>
